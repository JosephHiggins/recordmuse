...
class DataListener extends MuseDataListener {
    ...
    private void saveReading(final ArrayList<Double> data, ArrayList<ArrayList<Double>> toSave) {
        ...
        selectedData.add(data.get(Eeg.TP9.ordinal()));
        selectedData.add(data.get(Eeg.FP1.ordinal()));
        selectedData.add(data.get(Eeg.FP2.ordinal()));
        selectedData.add(data.get(Eeg.TP10.ordinal()));
